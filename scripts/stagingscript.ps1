...
$excludedLibraries = @("ModuleInit.dll", "NSubstitute.dll", "SimpleHttpMock.dll", "Ensure.That.dll", "FsCheck.dll", "FsCheck.Xunit.dll", "FSharp.Core.dll", "Microsoft.CodeAnalysis.Razor.dll", "SQLitePCLRaw.batteries_green.dll", "SQLitePCLRaw.batteries_v2.dll", "SQLitePCLRaw.provider.e_sqlite3.dll")
