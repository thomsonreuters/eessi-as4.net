...
namespace Eu.EDelivery.AS4.IntegrationTests.Positive_Receive_Scenarios._8._3._8_Receive_Multiple_Payloads_Compressed_Signed_Encrypted
{
    ...
    {
        private const string HolodeckMessageFilename = "\\8.3.8-sample.mmd";
        private readonly string _holodeckMessagesPath;
        private readonly string _destFileName;
        private readonly Holodeck _holodeck;

        public ReceiveMultiplePayloadsCompressedSignedEncryptedIntegrationTest()
        {
        ...
        public void ThenReceiveMultiplePayloadsSignedSucceeds()
        {
            ...
            // Arrange
            base.CopyPModeToHolodeckA("8.3.8-pmode.xml");
            ...
            if (areFilesFound) Console.WriteLine(@"Receive Multiple Payloads Compressed, Signed and Encrypted Integration Test succeeded!");
            else Retry();
        }
