    ...
    public class RuntimeLoader : IRuntimeLoader
    {
        ...
        private IEnumerable<Property> BuildProperties(Collection<PropertyDefinition> properties)
        {
            var runtimeProperties = properties
                ...
                .Select(prop =>
                {
                    var customAttr = prop.CustomAttributes.FirstOrDefault(attr => attr.GetType().Name == "CustomAttribute");
                    if (customAttr == null)
                    {
                    ...
                    else
                    {
                        ...
                        return new Property()
                        {
                            ...
                            Type = count > 1 ? arguments[1].Value as string : "",
                            Regex = count > 2 ? arguments[2].Value as string : ""
                        };
                    }
                });
