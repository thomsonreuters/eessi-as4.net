    ...
    return {
        ...
        module: {
            ...
            rules: [
                ...
                { test: /\.(png|jpe?g|gif|svg|woff|woff2|ttf|eot|ico)$/i, loader: 'file?name=./[hash].[ext]' },
        ...
        plugins: [
            ...
            new ContextReplacementPlugin(
                ...
                /angular(\\|\/)core(\\|\/)(esm(\\|\/)ui|ui)(\\|\/)linker/,
                helpers.root('ui') // location of your ui
            ),
