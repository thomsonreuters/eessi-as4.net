...
namespace Eu.EDelivery.AS4.Security.Builders
{
    ...
    internal class EncryptedKeyBuilderV2
    {
        ...
        private EncryptedKeyBuilderV2(X509Certificate2 certificate, byte[] key)
        {
            _certificate = certificate;
            _key = key;
        }

        public static EncryptedKeyBuilderV2 ForKey(byte[] symmetricKey, X509Certificate2 certificate)
        {
            return new EncryptedKeyBuilderV2(certificate, symmetricKey);
        }

        public EncryptedKeyBuilderV2 WithEncryptionMethod(string algorithmUri)
        {
            _algorithmUri = algorithmUri;
            return this;
        }

        public EncryptedKeyBuilderV2 WithDigest(string algorithmUri)
        {
            _digestAlgorithmUri = algorithmUri;
            return this;
        }

        public EncryptedKeyBuilderV2 WithMgf(string mgfAlgorithmUri)
        {
            _mgfAlgorithmUri = mgfAlgorithmUri;
            return this;
        }

        public EncryptedKeyBuilderV2 WithSecurityTokenReference(SecurityTokenReference reference)
        {
            this._securityTokenReference = reference;
            return this;
        }
