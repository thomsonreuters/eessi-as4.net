...
namespace Eu.EDelivery.AS4.UnitTests.Steps.Send
{
    ...
    public class GivenEncryptAS4MessageStepFacts
    {
        ...
        public class GivenValidArguments : GivenEncryptAS4MessageStepFacts
        {
            ...
            {
                // Arrange
                InternalMessage message = CreateEncryptedAS4Message();
            ...
            private static async Task<StepResult> ExerciseEncryption(InternalMessage message)
            {
        ...
        public class GivenInvalidArguments : GivenEncryptAS4MessageStepFacts
        {
            ...
            {
                // Arrange
                InternalMessage encryptedMessage = CreateEncryptedAS4Message();
                ...
                await Assert.ThrowsAsync<AS4Exception>(
                    () => _step.ExecuteAsync(encryptedMessage, CancellationToken.None));
            }
