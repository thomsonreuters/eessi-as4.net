    ...
    public class GivenErrorBuilderFacts
    {
        public class GivenValidArguments : GivenErrorBuilderFacts
        {
            ...
            public void ThenBuildErrorSucceedsWithEbmsMessageId()
            {
                ...
                // Act
                Error error = new ErrorBuilder(messageId)
                    .WithRefToEbmsMessageId(refToMessageId).Build();
                // Assert
            ...
            private void AssertErrorDetails(AS4Exception as4Exception, Error error)
            {
