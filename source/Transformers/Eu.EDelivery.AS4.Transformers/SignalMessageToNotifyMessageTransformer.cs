...
namespace Eu.EDelivery.AS4.Transformers
{
    ...
    public class NotifyMessageTransformer : ITransformer
    {
        ...
        public async Task<MessagingContext> TransformAsync(ReceivedMessage message, CancellationToken cancellationToken)
        {
            ...
            var as4Message = await RetrieveSignalMessage(entityMessage, cancellationToken);
        ...
        private static async Task<AS4Message> RetrieveSignalMessage(ReceivedEntityMessage receivedMessage, CancellationToken cancellationToken)
        {
            ...
            {
                return await RetrieveAS4Message(me, cancellationToken);
            }
