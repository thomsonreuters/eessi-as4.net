    ...
    template: `
        <div [formGroup]="form">
            ...
            <div formGroupName="collaborationInfo">
                ...
                <as4-input isLabelBold="true" label="Action">
                    <input type="text" formControlName="action" />
                </as4-input>
                <as4-input isLabelBold="true" label="Service">
                ...
                <as4-input isLabelBold="true" label="Agreement reference" formGroupName="agreementReference">
                    <as4-columns>
                        <input type="text" formControlName="value" placeholder="value" />
                        <input type="text" formControlName="type" placeholder="type" />
                    </as4-columns>
                </as4-input>
                <as4-input isLabelBold="true" label="PmodeId" formGroupName="agreementReference">
