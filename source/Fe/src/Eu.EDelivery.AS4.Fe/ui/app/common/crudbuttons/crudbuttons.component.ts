...
@Component({
    ...
    template: `
            ...
            <button type="button" class="btn btn-flat save-button" (click)="save.emit()" [class.btn-primary]="form.dirty" [disabled]="!form.dirty"><i class="fa fa-save"></i></button>
            <button type="button" class="btn btn-flat delete-button" (click)="delete.emit()" [disabled]="!!!current"><i class="fa fa-trash-o"></i></button>
            <button type="button" class="btn btn-flat reset-button" (click)="reset.emit()" [class.btn-primary]="form.dirty" [disabled]="!form.dirty"><i class="fa fa-undo"></i></button>
