...
@Component({
    ...
    template: `
        <button as4-tooltip="Rename" type="button" as4-auth class="btn btn-flat rename-button" (click)="rename.emit()" [attr.disabled]="!!!current || null"><i class="fa fa-edit"></i></button>
