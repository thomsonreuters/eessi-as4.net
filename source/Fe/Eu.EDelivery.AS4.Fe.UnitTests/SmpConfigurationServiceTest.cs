...
namespace Eu.EDelivery.AS4.Fe.UnitTests
{
    ...
    {
        private SmpConfiguration.SmpConfiguration _smpConfiguration;

        public DatastoreContext DbContext { get; private set; }
        public DbContextOptions<DatastoreContext> Options { get; private set; }
        ...
        protected virtual async Task<SmpConfigurationServiceTest> Setup()
        {
